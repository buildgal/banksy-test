...
Future developement would be to add the test to this (https://github.com/BeresIvan/BuyingBanksy) repo and include test that navgiate the content of each page. 
...
Feature: I can open my application and browse the product 

    Scenario: I am able to open each page 
        Given I open Buying Banksy home page 
        When I open Buying Banksy gallery page 
        Then I open Buying Banksy cart page 
        Then I open Buying Banksy payment page 
        Then I open Buying Banksy login page
        Then I open Buying Banksy sign up page
        Then I open Buying Banksy review page   
